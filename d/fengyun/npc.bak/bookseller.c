...
void create()
{
	...
	set("per",30);
	set("vendor_goods", ([
                "诗集文摘": __DIR__"obj/book",
                "内功心法": __DIR__"obj/book3",
                "轻功入门": __DIR__"obj/book4",
                "魔法简介": __DIR__"obj/book5",
                "符咒入门": __DIR__"obj/book6",
                "玉蒲团": __DIR__"obj/book7",
                "金瓶梅": __DIR__"obj/book8",
